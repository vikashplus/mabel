...
class MabelZipperEnv(frankaBaseEnv):
    def __init__(self):
        curr_dir = os.path.dirname(os.path.abspath(__file__))
        model_path = curr_dir+'/mabel_zipper-v0.xml'
        ...
        self.target = self.sim.model.site_name2id('handle')
...
class MabelZipperEnvFixed(MabelZipperEnv):
    def __init__(self):
        super().__init__()
...
class MabelZipperEnvRandom(MabelZipperEnv):
    def __init__(self):
        super().__init__()
